 ...
 * @author Krull
 */
public class FrmSesionJuego extends javax.swing.JFrame {
    ...
    public FrmSesionJuego(Examen examen, ArrayList<Integer> preguntas) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(304, 4, 460, 490));
    ...
    private void jLBotonInicioMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLBotonInicioMouseReleased
        ...
        try {
            ...
            if (usuario != null) {
                JOptionPane.showMessageDialog(this, "Bienvenido al juego " + usuario.getNombre() + "!");
                new FrmInicioJuego(usuario, exam.getIdExamen(), listaPreguntas).setVisible(true);
                this.dispose();
            } else if (administrador != null) {
                JOptionPane.showMessageDialog(this, "Ingresa con una cuenta diferente al administrador");
            } else {
